 ...
 <body>
    <div class="container box">
        ...
        <ul class="nav nav-tabs">
            ...
            <li role="presentation"><a id="shortlisted_results" class="nav-link" href="index.php">Shortlisted</a></li>
...
<!--         <div align ="right"> <!-- It will show Modal for Create new Records !
    ...
    <div class="row"> <!-- Seventh Row ( Application For Transfer | Motivation For Transfer Attached | Reason For Transfer )-->
        <div class="col-4"> <!-- Application For Transfer -->
            ...
            <input class="form-check-input" type="checkbox" value="" id="chkbxApplicationForTransfer" name="chkbxApplicationForTransfer">
        </div>
        <div class="col-4 TransferGroup" > <!-- Transfer Attached -->
            ...
            <input class="form-check-input" type="checkbox" value="" id="chkbxMotivationTransfer" name="chkbxMotivationTransfer">
        </div>
    ...
    <div class="row" id="RCP_Section"> <!-- RCP_Section -->
        <div class="col-md-3">
            ...
            <div class="list-group" id="RCP_Gauteng_Cities">
                ...
                <input class="form-check-input me-1" type="checkbox" name="RCP_Gauteng[]" id="RCP_Gauteng_JHB" value="Johannesburg">Johannesburg</label>
                <label class="list-group-item">
                <input class="form-check-input me-1" type="checkbox" name="RCP_Gauteng[]" id="RCP_Gauteng_PTA" value="Pretoria">Pretoria</label>
            </div>
            <br>
            <label for="input_rcp_gp_cities" class="form-label">Name of City:</label> <!-- Name of the city candidate is applying for as RCP  -->
        ...
        <div class="col-md-3">
            ...
            <div class="list-group" id="RCP_WP_Cities">
                <label class="list-group-item">
                <input class="form-check-input me-1" type="checkbox" name="RCP_Gauteng[]" id="RCP_WP_CT" value="Cape Town">Cape Town</label>
                <label class="list-group-item">
                <input class="form-check-input me-1" type="checkbox" name="RCP_Gauteng[]" id="RCP_WP_George" value="George">George</label>
            </div>
            <br>
            <label for="input_rcp_wp_cities" class="form-label">Name of City:</label> <!-- Name of the city candidate is applying for as RCP  -->
        ...
        <div class="col-md-3">
            ...
            <div class="list-group" id="RCP_KZN_Cities">
                <label class="list-group-item">
                <input class="form-check-input me-1" type="checkbox" name="RCP_Gauteng[]" id="RCP_KZN_DBN" value="Durban">Durban</label>
                <label class="list-group-item">
                <input class="form-check-input me-1" type="checkbox" name="RCP_Gauteng[]" id="RCP_KZN_PMB" value="Pietermaritzburg">Pietermaritzburg</label>
            </div>
            <br>
            <label for="input_rcp_kzn_cities" class="form-label">Name of City:</label> <!-- Name of the city candidate is applying for as RCP  -->
    ...
    <div class="row" id="Reg_Mag_Section"> <!-- Reg Mag Section -->
        <div class="col-md-3">
            ...
            <div class="list-group" id="Reg_Mag_Gauteng_Cities">
                <label class="list-group-item">
                <input class="form-check-input me-1" type="checkbox" name="Reg_mag_Gauteng" value="Johannesburg">Johannesburg</label>
                <label class="list-group-item">
...
/*             console.log("New page");
            ...
            function fetchUser() // This function will fetch data from table and display under <div id="result">
            {
                ...
                landline_number:landline_number}, //action variable data has been send to server
                success:function(data){
                    //$('#result').html(data); //It will display data under div tag with id result
            ...
            //This area is for selecting candidates #Not working
 ...
 */
        ...
        /* $('#action').click(function(){
            ...
            var rcp_gp_city = $('#input_rcp_gp_cities').val(); //Get the value of last name textbox
            var rcp_wp_city = $('#input_rcp_wp_cities').val(); //Get the value of last name textbox
            var rcp_kzn_city = $('#input_rcp_kzn_cities').val(); //Get the value of last name textbox
        ...
        //The section below will update Candidates
        ...
        $(document).on('click', '.update', function(){
            ...
            var qualification_year = $('#inputQualification_Year').val(); //Get the value of last name textbox
            var disabled_person = $('#chkbxIsDisabled').val(); //Get the value of last name textbox
            var disablility_details = $('#inputDisabilitiesDetails').val(); //Get the value of last name textbox
            var application_for_transfer = $('#chkbxApplicationForTransfer').val(); //Get the value of last name textbox
            var motivation_for_transfer_attached = $('#chkbxMotivationTransfer').val(); //Get the value of last name textbox
            var reason_for_transfer = $('#inputTransferReason').val(); //Get the value of last name textbox
            var remarks = $('#inputRemarks').val(); //Get the value of last name textbox
            ...
            data:{id:id,
                ...
                qualification_year:qualification_year,
                disabled_person:disabled_person,
                disablility_details:disablility_details,
                application_for_transfer:application_for_transfer, 
                motivation_for_transfer_attached:motivation_for_transfer_attached,  
                reason_for_transfer:reason_for_transfer,
                acting_experience:acting_experience,
                ...
                $('#inputQualification_Year').val(data.qualification_year); //Get the value of last name textbox
                $('#chkbxIsDisabled').val(data.disabled_person); //Get the value of last name textbox
                $('#inputDisabilitiesDetails').val(data.disablility_details); //Get the value of last name textbox
                $('#chkbxApplicationForTransfer').val(data.application_for_transfer); //Get the value of last name textbox
                $('#chkbxMotivationTransfer').val(data.motivation_for_transfer_attached); //Get the value of last name textbox
                $('#inputTransferReason').val(data.reason_for_transfer); //Get the value of last name textbox
                $('#inputRemarks').val(data.remarks);     //It will define value of id variable to this customer id hidden field
